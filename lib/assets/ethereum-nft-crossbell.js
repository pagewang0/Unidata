...
class EthereumNFTCrossbell extends base_1.default {
    provider;
    contracts;
    constructor(main) {
        super(main);
    ...
    async init() {
        const abi = (this.provider = new ethers_1.ethers.providers.JsonRpcProvider('https://rpc.crossbell.io'));
        this.contracts = [
            {
                abi: [
                    {
    ...
    async get(options) {
        ...
        const contract = new ethers_1.ethers.Contract(this.contracts[0].address, this.contracts[0].abi, this.provider);
...
exports.default = EthereumNFTCrossbell;
